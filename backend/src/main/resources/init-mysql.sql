...
-- =====================================================================
-- 3. 用户QQ账号绑定表 (user_qq_bindings) - 支持一个用户绑定多个QQ
-- =====================================================================
...
-- =====================================================================
-- 5. 文件记录表 (file_records) - 存储文件元数据（图片/语音/视频/文件）
-- =====================================================================
...
-- =====================================================================
-- 9. 用户设置表 (user_settings) - 存储用户的个性化设置
-- =====================================================================
...
-- =====================================================================
-- 10. 群聊阅读进度表 (group_read_state) - 记录每个 (用户, 群聊) 的 last_read_time
-- =====================================================================
...
-- ALTER TABLE messages ADD COLUMN deleted BOOLEAN DEFAULT FALSE COMMENT '用户软删除标记' AFTER archived;
-- ALTER TABLE messages ADD COLUMN deleted_at TIMESTAMP NULL COMMENT '删除时间' AFTER deleted;
-- ALTER TABLE messages ADD COLUMN deleted_by BIGINT NULL COMMENT '删除的用户ID(users.id)' AFTER deleted_at;
-- ALTER TABLE messages ADD INDEX idx_deleted (deleted);
-- ALTER TABLE messages ADD INDEX idx_self_deleted (self_qq, deleted);
