...
CREATE TABLE IF NOT EXISTS credit_rule (
    ...
    -- 直购积分档位（客户端订阅页「直购积分」分组，名称按积分数展示：直购积分·2000 等）
    plan_lite_price         DECIMAL(10,2)   NOT NULL DEFAULT 9.90  COMMENT '直购积分·2000 价格(元)',
    plan_lite_credit        INT             NOT NULL DEFAULT 2000 COMMENT '直购积分·2000 赠送积分',
    plan_pro_price          DECIMAL(10,2)   NOT NULL DEFAULT 59.00 COMMENT '直购积分·4000 价格(元)',
    plan_pro_credit         INT             NOT NULL DEFAULT 4000 COMMENT '直购积分·4000 赠送积分',
    plan_pro_plus_price     DECIMAL(10,2)   NOT NULL DEFAULT 219.00 COMMENT '直购积分·12000 价格(元)',
    plan_pro_plus_credit    INT             NOT NULL DEFAULT 12000 COMMENT '直购积分·12000 赠送积分',
    plan_ultra_price        DECIMAL(10,2)   NOT NULL DEFAULT 629.00 COMMENT '直购积分·40000 价格(元)',
    plan_ultra_credit       INT             NOT NULL DEFAULT 40000 COMMENT '直购积分·40000 赠送积分',
    plan_mega_price         DECIMAL(10,2)   NOT NULL DEFAULT 648.00 COMMENT '直购积分·100000 价格(元)',
    plan_mega_credit        INT             NOT NULL DEFAULT 100000 COMMENT '直购积分·100000 赠送积分',
    -- 会员月卡（客户端订阅页「会员月卡」分组）
    plan_small_month_card_price        DECIMAL(10,2) NOT NULL DEFAULT 30.00  COMMENT '小月卡价格(元)',
    plan_small_month_card_credit       INT           NOT NULL DEFAULT 3000   COMMENT '小月卡赠送积分',
    plan_small_month_card_daily_bonus  INT           NOT NULL DEFAULT 100    COMMENT '小月卡每日签到额外积分',
    plan_large_month_card_price        DECIMAL(10,2) NOT NULL DEFAULT 68.00  COMMENT '大月卡价格(元)',
    plan_large_month_card_credit       INT           NOT NULL DEFAULT 8000   COMMENT '大月卡赠送积分',
    plan_large_month_card_daily_bonus  INT           NOT NULL DEFAULT 300    COMMENT '大月卡每日签到额外积分(双持=两张卡相加)',
    plan_duration_days      INT             NOT NULL DEFAULT 30   COMMENT '套餐时长(天)',
