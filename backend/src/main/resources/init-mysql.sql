...
CREATE TABLE IF NOT EXISTS credit_transaction (
    id              BIGINT          AUTO_INCREMENT      PRIMARY KEY,
    user_id         BIGINT          NOT NULL            COMMENT '用户ID',
    type            VARCHAR(30)     NOT NULL            COMMENT 'NEW_USER_BONUS/SIGN_IN/AI_CONSUMPTION/AI_CHAT/AI_ANALYZE/TTS_SYNTHESIS/SUBSCRIPTION_PURCHASE/REFUND/ADMIN_GRANT/ADMIN_DEDUCT/EXPIRE/MONTHLY_CARD_DAILY',
